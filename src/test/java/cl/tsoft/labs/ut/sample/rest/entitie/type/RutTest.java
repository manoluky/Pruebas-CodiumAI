...
class RutTest {
    ...
    @Test
    public void test_convert_empty_string_to_rut_object() {
        // Arrange
        RutConverter converter = new RutConverter();
    ...
    @Test
    public void test_convert_null_string_to_rut_object() {
        // Arrange
        RutConverter converter = new RutConverter();

        // Act
        Rut result = converter.convertToEntityAttribute(null);

        // Assert
        assertNull(result);
    }
    @Test
    public void test_convert_null_rut_object_to_string() {
        // Arrange
        RutConverter converter = new RutConverter();
    ...
    @Test
    public void test_convert_invalid_rut_to_string_representation() {
        // Arrange
        RutConverter converter = new RutConverter();
        Rut rut = new Rut(0, 'X');
